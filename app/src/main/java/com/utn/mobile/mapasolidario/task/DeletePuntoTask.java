...
public class DeletePuntoTask extends RoboAsyncTask<BasePoint> {
    ...
    public DeletePuntoTask(Context context, String id) {
        super(context);
        clave = id;
    }
    ...
    public BasePoint call() throws Exception {
        BasePoint retVal = remoteService.deletePuntoService(clave);
        return retVal;
    }
